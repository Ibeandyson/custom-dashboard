...
import FailedDepositTable from './subcomponent/FailedDepositTable';
...
const FailedDeposit  = () => {
    ...
    const loadData = () => {
        setLoading(true);
        axios
            .get(`${url}/api/admin/deposit/list/failed`, {
                headers: {
        ...
        <div>
            ...
            <div class="pt-5">
                <div class="card my-card-look">
                    <div class="card-header my-card-head my-card-head-text">Failed Deposit</div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>{withdrawaldata.map(data => <FailedDepositTable data={data} />)}</tbody>
                                <InfiniteScroll
